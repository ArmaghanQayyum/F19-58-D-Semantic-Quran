...
<body class="">
	  ...
	  ?>
        <ul class="nav">
			  ...
			  while($row = mysqli_fetch_array($result)) { ?>
				<li><a href="Ayat.php?id= <?php echo $row['chapter']; ?> "> 
				<?php echo $row['chapter'];
				echo ":"." ";
				echo $row['romanname'];
				echo " "." "." "." "; ?>
				<?php echo $row['arabicname'];
				?> </a></li>
			  <?php }?>
  ...
  <?php 
	  $query1 = "SELECT verse,text from quran where chapter=1";
          ...
          <div class="row">
            <div class="credits ml-auto">
              <span class="copyright">
                ...
                </script>, made with <i class="fa fa-heart heart"></i> by Samentic Quran Team
              </span>
            </div>
          </div>
        </div>
